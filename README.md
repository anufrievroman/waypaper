...
### Automatic wallpaper change (slideshow)

To rotate wallpapers automatically, open the slideshow panel from the options menu in the GUI, set an interval, and start it. For other ways to run the slideshow daemon, see the [documentation](https://anufrievroman.gitbook.io/waypaper/usage).
